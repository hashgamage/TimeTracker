...
- Create Angular project with ng: `ng new test.timetracker.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`test.timetracker.client.esproj`).
